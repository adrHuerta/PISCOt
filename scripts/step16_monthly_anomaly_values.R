...
anom_mtx <- cbind(anom_mtx , HM_stats_2[,c("XX", "YY", "CC","n_mean")] )
...
mtx <- cbind(mtx , HM_stats_2[,c("XX", "YY", "CC","n_mean")] )
...
anom_mtn <- cbind(anom_mtn , HM_stats_2[,c("XX", "YY", "CC","n_mean")] )
...
mtn <- cbind(mtn , HM_stats_2[,c("XX", "YY", "CC","n_mean")] )
